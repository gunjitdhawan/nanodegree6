...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private void sendWeatherInfoToWearable() {
        ...
        Uri uri = WeatherContract.WeatherEntry.buildWeatherLocationWithStartDate(loc, date);
        ...
        if (cursor.moveToFirst()) {
            ...
            if (connectionResult.isSuccess()) {
                String maxTemp = Utility.formatTemperature(context, cursor.getDouble(INDEX_MAX_TEMP));
                String minTemp = Utility.formatTemperature(context, cursor.getDouble(INDEX_MIN_TEMP));
                int weatherID = cursor.getInt(INDEX_WEATHER_ID);

                PutDataMapRequest dataMapRequest = PutDataMapRequest.create(WEAR_DATA_PATH);
                DataMap map = dataMapRequest.getDataMap();
                map.putString(WEAR_MAX_TEMP_KEY, maxTemp);
                map.putString(WEAR_MIN_TEMP_KEY, minTemp);
                map.putInt(WEAR_WEATHER_CONDITION_KEY, weatherID);
